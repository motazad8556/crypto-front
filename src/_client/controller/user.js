    ...
    UserController.prototype.updateAccount = function (request, token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ConnectionManager_1.default
                            .call(routes_1.AUTH_ROUTES.UPDATE_ACCOUNT, request, token)];
                    case 1:
                        result = _a.sent();
    ...
    UserController.prototype.fetchAccount = function (request, token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ConnectionManager_1.default
                            .call(routes_1.AUTH_ROUTES.FETCH_ACCOUNT, request, token)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
...
exports.default = UserController.Instance;
