...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.signUp = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ConnectionManager_1.default.call(routes_1.AUTH_ROUTES.SIGN_UP, request)];
                    case 1:
                        result = _a.sent();
    ...
    AuthController.prototype.signIn = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ConnectionManager_1.default.call(routes_1.AUTH_ROUTES.SIGN_IN, request)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
    ...
    AuthController.prototype.changePassword = function (request, jwt) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ConnectionManager_1.default.call(routes_1.AUTH_ROUTES.CHANGE_PASSWORD, request, jwt)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
...
exports.default = AuthController.Instance;
